...
/**
 Shows the user a square representing a detected plane in ARKit.
 
 From Apple's ARKit demo: https://developer.apple.com/documentation/arkit/handling_3d_interaction_and_ui_controls_in_augmented_reality
 **/
...
private  func SCNVector3Uniform(_ value: Float) -> SCNVector3 {
    return SCNVector3Make(value, value, value)
}

private  func SCNVector3Uniform(_ value: CGFloat) -> SCNVector3 {
    return SCNVector3Make(Float(value), Float(value), Float(value))
}

// MARK: - SCNMaterial extensions

fileprivate extension SCNMaterial {
...
fileprivate extension Array where Iterator.Element == CGFloat {
    var average: CGFloat? {
        guard !isEmpty else {
            return nil
        }
...
fileprivate extension Array where Iterator.Element == SCNVector3 {
